		...
		<div id="listWrap3" class="listWrap3">
			<div class="listWrap4">
				...
				<div id="listWrap5" class="listWrap5">
					...
					<c:if test="${magazineVO.categoryId eq 3}">
						<div class="titleWrap">
							<h3 class="title">2017 MMA 결산특집</h3>
						</div>
						<div class="titleBannerWrap">
							<img class="titleBanner" src="http://cdnimg.melon.co.kr/resource/image/cds/musicstory/imgUrl20171016062224412.jpg" width="1008" height="92" /></div>
					</c:if>
					
					<c:if test="${magazineVO.categoryId eq 4}">
						<div class="titleWrap">
							<h3 class="title">금주의 신보</h3>
						</div>
						<div class="titleBannerWrap">
							<img class="titleBanner" src="http://cdnimg.melon.co.kr/resource/image/cds/musicstory/imageUrl20160111055851.jpg" width="1008" height="92" /></div>
					</c:if>
					
					<c:if test="${magazineVO.categoryId eq 5}">
						<div class="titleWrap">
							<h3 class="title">금주의 차트</h3>
						</div>
						<div class="titleBannerWrap">
							<img class="titleBanner" src="http://cdnimg.melon.co.kr/resource/image/cds/musicstory/imageUrl20150122031255.jpg" width="1008" height="92" /></div>
					</c:if>
					
					<c:if test="${magazineVO.categoryId eq 6}">
						<div class="titleWrap">
							<h3 class="title">아티스트 갤러리</h3>
						</div>
						<div class="titleBannerWrap">
							<img class="titleBanner" src="http://cdnimg.melon.co.kr/resource/image/cds/musicstory/imageUrl20150122031243.jpg" width="1008" height="92" /></div>
					</c:if>
					
					<c:if test="${magazineVO.categoryId eq 7}">
						<div class="titleWrap">
							<h3 class="title">이슈 포커스</h3>
						</div>
						<div class="titleBannerWrap">
						<img class="titleBanner" src="http://cdnimg.melon.co.kr/resource/image/cds/musicstory/imageUrl20150122031330.jpg" width="1008" height="92" /></div>
					</c:if>
